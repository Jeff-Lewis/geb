/**
 * Задание параметров отчёта RR - Групповое изменение
 */
(function() {
	...
	function edit() {
		...
		Ext.Ajax.request({
			url : 'rest/RiskRewardSetupParams/Adds.do',
			params : {
				securities : ids,
	...
	return new Ext.Panel({
		id : 'RiskRewardSetupParamsEditGroup-component',
		layout : 'border',
		frame : true,
		closable : true,
		title : 'Групповое изменение параметров RR',
