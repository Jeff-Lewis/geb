...
var services = {
	...
	items : [ {
		...
		text : 'Редактирование акций',
		handler : function() {
			showPanel('services/ViewShare');
		}
	}, {
		text : 'Редактирование свопов',
		handler : function() {
			showPanel('services/ViewSwaps');
		}
	}, {
		text : 'Редактирование облигаций',
		handler : function() {
			showPanel('services/ViewBonds');
		}
	}, {
		text : 'Редактирование фьючерсов',
		handler : function() {
		...
		handler : function() {
			showPanel('services/LoadQuotes');
		}
	}, {
		text : 'Загрузка доходности облигаций',
		handler : function() {
			showPanel('services/LoadBondYeild');
		}
	}, {
		text : 'Загрузка номинала',
		handler : function() {
			showPanel('services/LoadValues');
		}
	}, {
		text : 'Загрузка ставки по купонам',
		handler : function() {
			showPanel('services/LoadRateCoupon');
		}
	}, {
		text : 'Загрузка дат погашений',
		handler : function() {
			showPanel('services/LoadCashFlow');
		}
	}, {
		text : 'Загрузка ATR',
		handler : function() {
			showPanel('services/LoadATR');
		}
	}, {
		text : 'Цена1 для RR',
...
function createMenuItems() {
	...
	return [ _createMenuGroup(dictionary), _createMenuGroup(services),
			_createMenuGroup(operationsCB), _createMenuGroup(portfolio),
