...
public class FundsDaoImpl implements FundsDao
{
	...
	public List<ReferenceItem> findAll() {
		String sql = "execute dbo.mo_WebGet_SelectPortfolio_sp";
	...
	public int put(String name, String comment) {
		String sql = "execute dbo.mo_WebSet_putInvestPortfolio_sp ?, ?";
	...
	public int updateById(Long id, String name, String comment) {
		String sql = "execute dbo.mo_WebSet_udInvestPortfolio_sp 'u', ?, ?, ?";
		Query q = em.createNativeQuery(sql)
				.setParameter(1, id)
				.setParameter(2, name)
